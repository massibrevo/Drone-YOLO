...
## Title.
st.write("# Drone-YOLO-Search for missing people 👁🌲🛰️")

with st.form("project_access"):
    st.write("#### Select 'Verify and Load Model' after load proper image, entering Project URL andAPI Key to receive predictions")
    ...
    st.write("Author: Massimiliano Brevini")
    if submitted:
